"""Kernels for MaxPlusSumConv1d.

Definition:

    out[b, oc, ol] = \sum_{ic} \max_{kl}( img[b, ic, ol*sl + kl*dl] + weight[oc, ic, kl] )
...
def max_plus_sum_conv1d_kernel(
    batch_size,
    in_channels,
    out_channels,
    in_length,
    ...
    """Forward kernel for MaxPlusSumConv1d (NCL input, OIK weight, NOL output)."""
...
def max_plus_sum_conv1d_kernel_backward_dweight(
    batch_size,
    in_channels,
    out_channels,
    in_length,
    ...
    """Compute gradient w.r.t. weight for MaxPlusSumConv1d."""
...
def max_plus_sum_conv1d_kernel_backward_dinput(
    batch_size,
    in_channels,
    out_channels,
    in_length,
    ...
    """Compute gradient w.r.t. input for MaxPlusSumConv1d."""
