...
from .min_max_plus_sum_plus_conv2d_sharedOpt import (
    ...
    min_max_plus_sum_plus_conv2d_kernel_backward_dweight,
    min_max_plus_sum_plus_conv2d_kernel_backward_dinput,
)
...
def _compile_backward_kernel_dweight_cached(*key, maxmin_gradient="multiple"):
    return min_max_plus_sum_plus_conv2d_kernel_backward_dweight(*key, maxmin_gradient=maxmin_gradient)


@lru_cache(maxsize=1)
def _compile_backward_kernel_dinput_cached(*key, maxmin_gradient="multiple"):
    return min_max_plus_sum_plus_conv2d_kernel_backward_dinput(*key, maxmin_gradient=maxmin_gradient)
