"""Kernels for MinPlusSumConv3d.

Definition:

    out[b, oc, od, oh, ow] = \sum_{ic} \min_{kd,kh,kw}(
...
Tie handling for the inner min is controlled by `maxmin_gradient`:
- "single": pick the first min position
- "multiple": distribute gradient uniformly across all min positions
"""
...
def min_plus_sum_conv3d_kernel(
    batch_size,
    in_channels,
    out_channels,
    in_depth,
    ...
    """Forward kernel for MinPlusSumConv3d (NCDHW input, OIDHW weight, NCDHW output)."""
...
def min_plus_sum_conv3d_kernel_backward_dweight(
    batch_size,
    in_channels,
    out_channels,
    in_depth,
    ...
    """Compute gradient w.r.t. weight for MinPlusSumConv3d."""
...
def min_plus_sum_conv3d_kernel_backward_dinput(
    batch_size,
    in_channels,
    out_channels,
    in_depth,
    ...
    """Compute gradient w.r.t. input for MinPlusSumConv3d."""
