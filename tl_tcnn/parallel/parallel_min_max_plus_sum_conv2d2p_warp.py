...
from .parallel_min_max_plus_sum_conv2d2p import (
    parallel_min_max_plus_sum_conv2d2p_kernel,
    # parallel_min_max_plus_sum_conv2d2p_kernel_tiled as parallel_min_max_plus_sum_conv2d2p_kernel,
...
class _ParallelMinMaxPlusSumConv2d2p(autograd.Function):
    ...
    def forward(
        ...
        conv_module._run_forward_kernel(input_nchw, weight1_oikk, weight2_oikk, alpha_oi, beta_oi, output, out_height, out_width)
...
class ParallelMinMaxPlusSumConv2d2p(_Parallel2p):
    """Parallel Min-Max-Plus-Sum 2D Convolutional Layer with 2 Parameters."""
