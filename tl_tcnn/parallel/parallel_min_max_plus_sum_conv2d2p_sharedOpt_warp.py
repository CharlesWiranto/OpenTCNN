...
from ..utils import _pair, dtype_map
...
from .parallel_min_max_plus_sum_conv2d2p_sharedOpt import (
    ...
    parallel_min_max_plus_sum_conv2d2p_backward_dweight,
    parallel_min_max_plus_sum_conv2d2p_backward_dinput,
)
...
def _compile_backward_kernel_dweight_cached(*key, maxmin_gradient="multiple"):
    return parallel_min_max_plus_sum_conv2d2p_backward_dweight(
        *key,
