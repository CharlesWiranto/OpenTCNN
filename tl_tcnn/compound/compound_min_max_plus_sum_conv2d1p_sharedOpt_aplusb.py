                            ...
                            for kh in T.serial(kernel_height):
                                for kw in T.serial(kernel_width):
                                    ...
                                    if (vnegmax[0] != -T.infinity(dtype)) and (-vals[kh, kw] == vnegmax[0]) and (min_h[0] == -1):
                                        ...
                                        min_w[0] = kw
                            if max_h[0] >= 0:
                                local_dw[max_h[0], max_w[0]] = local_dw[max_h[0], max_w[0]] + alpha_out[0]
                            if min_h[0] >= 0:
                                local_dw[min_h[0], min_w[0]] = local_dw[min_h[0], min_w[0]] + alpha_out[0]
                    T.sync_threads()
...
# @tilelang.jit
def compound_min_max_plus_sum_conv2d1p_backward_dinput_dweight(
    batch_size,
    in_channels,
    out_channels,
    in_height,
                            ...
                            if icg < in_channels:
                                ...
                                if split_ties:
                                    ...
                                    if min_h[0] >= 0:
                                        ...
                                        if (ih2 >= 0) and (ih2 < in_height) and (iw2 >= 0) and (iw2 < in_width):
                                            T.atomic_add(dimg_buffer[b, icg, ih2, iw2], alpha_out[0])
                                            T.atomic_add(dweight_buffer[oc, icg, min_h[0], min_w[0]], alpha_out[0])
...
# @tilelang.jit
def compound_min_max_plus_sum_conv2d1p_backward_dinput_dweight_dab(
    batch_size,
    in_channels,
    out_channels,
    in_height,
                        ...
                        for ii in T.serial(TILE_IC):
                            ...
                            if icg < in_channels:
                                ...
                                if vnegmax[0] != -T.infinity(dtype):
                                    T.atomic_add(dalpha_buffer[oc, icg], (-vnegmax[0]) * local_dout[0])
