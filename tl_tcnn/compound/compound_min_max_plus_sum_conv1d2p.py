"""This is the file containing kernels used for CompoundMinMaxPlusSumConv1d2p operation."""
...
def compound_min_max_plus_sum_conv1d2p_kernel(
    batch_size,
    in_channels,
    out_channels,
    in_width,
...
def compound_min_max_plus_sum_conv1d2p_kernel_tiled(
    batch_size,
    in_channels,
    out_channels,
    in_width,
...
# @tilelang.jit
def compound_min_max_plus_sum_conv1d2p_backward_dab(
    batch_size,
    in_channels,
    out_channels,
    in_width,
...
# @tilelang.jit
def compound_min_max_plus_sum_conv1d2p_backward_dweight(
    batch_size,
    in_channels,
    out_channels,
    in_width,
                    ...
                    for bw_block in T.serial(T.ceildiv(BW, BLOCK_BW)):
                        ...
                        for bw_offset in T.serial(TILE_BW):
                            ...
                            if bw < BW:
                                ...
                                if min_argw[0] != -1:
                                    local_dweight_acc[min_argw[0]] += (local_beta[0] * local_dout[bw_offset])
...
# @tilelang.jit
def compound_min_max_plus_sum_conv1d2p_backward_dinput(
    batch_size,
    in_channels,
    out_channels,
    in_width,
    ...
    the argmax/argmin locations of img + weight over (kw), scaled by alpha and beta
    respectively.
    """    
    batches = batch_size
    patches = out_channels * out_width
