...
def compound_min_max_plus_sum_conv2d_kernel(
    batch_size,
    in_channels,
    out_channels,
    in_height,
...
def compound_min_max_plus_sum_conv2d_kernel_tiled(
    batch_size,
    in_channels,
    out_channels,
    in_height,
...
# @tilelang.jit
def compound_min_max_plus_sum_conv2d_backward_dweight(
    batch_size,
    in_channels,
    out_channels,
    in_height,
...
# @tilelang.jit
def compound_min_max_plus_sum_conv2d_backward_dinput(
    batch_size,
    in_channels,
    out_channels,
    in_height,
...
# @tilelang.jit
def compound_min_max_plus_sum_conv2d_backward_dinput_tiled(
    batch_size,
    in_channels,
    out_channels,
    in_height,
...
# @tilelang.jit
def compound_min_max_plus_sum_conv2d_backward_dinput_dweight(
    batch_size,
    in_channels,
    out_channels,
    in_height,
