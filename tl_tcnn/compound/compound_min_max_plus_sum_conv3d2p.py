...
def compound_min_max_plus_sum_conv3d2p_kernel(
    batch_size,
    in_channels,
    out_channels,
    in_height,
...
def compound_min_max_plus_sum_conv3d2p_kernel_tiled(
    batch_size,
    in_channels,
    out_channels,
    in_height,
...
# @tilelang.jit
def compound_min_max_plus_sum_conv3d2p_backward_dab(
    batch_size,
    in_channels,
    out_channels,
    in_height,
...
# @tilelang.jit
def compound_min_max_plus_sum_conv3d2p_backward_dweight(
    batch_size,
    in_channels,
    out_channels,
    in_height,
                    ...
                    for bhwd_block in T.serial(T.ceildiv(BHWD, BLOCK_BHWD)):
                        ...
                        for bhwd_offset in T.serial(TILE_BHWD):
                            ...
                            if bhwd < BHWD:
                                ...
                                if min_argh[0] != -1:
                                    local_dweight_acc[min_argh[0], min_argw[0], min_argd[0]] += (local_beta[0] * local_dout[bhwd_offset])
...
# @tilelang.jit
def compound_min_max_plus_sum_conv3d2p_backward_dinput(
    batch_size,
    in_channels,
    out_channels,
    in_height,
    ...
    the argmax/argmin locations of img + weight over (kh, kw, kd), scaled by alpha and beta
    respectively.
    """    
    batches = batch_size
    patches = out_channels * out_height * out_width * out_depth
